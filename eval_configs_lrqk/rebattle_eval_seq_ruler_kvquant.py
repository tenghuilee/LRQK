...
models = [
    dict(
        type="KVQuantChatBot",
        abbr='llama-3.1-8B-1M_kvquant',
        path='./llama_hf/Meta-Llama-3.1-8B-Instruct',
        max_out_len=1024,
        batch_size=1,
        run_cfg=dict(num_gpus=1),
        kvquant_config=dict(
            quantizer_path="./kvquant.pickle/quantizers_meta_llama-3.1-8B-Instruct.pickle",
        )
    ),
    dict(
        type="LRQKChatBot",
        abbr=f"llama-3.1-8B-1M_LRQKChatBot_r32_act2048_lite64_kvquant",
        path="./llama_hf/Meta-Llama-3.1-8B-Instruct",
        max_out_len=1024,
        batch_size=1,
        run_cfg=dict(num_gpus=1),
    ...
    dict(
        type="KVQuantChatBot",
        abbr='Qwen2.5-7B-Instruct_kvquant',
    ...
    dict(
        type="LRQKChatBot",
        abbr=f"Qwen2.5-7B-Instruct_LRQKChatBot_r32_act2048_lite64_kvquant",
        path='Qwen/Qwen2.5-7B-Instruct',
        max_out_len=1024,
        batch_size=1,
        run_cfg=dict(num_gpus=1),

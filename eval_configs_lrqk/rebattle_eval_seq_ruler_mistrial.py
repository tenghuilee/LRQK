...
pre_datasets = sum((v for k, v in locals().items()
...
models = [
    ...
    dict(
        type="LRQKChatBot",
        abbr=f"Mistral-7B-Instruct-v0.3_LRQKChatBot_r32_act2048_lite64",
        path='mistralai/Mistral-7B-Instruct-v0.3',
        max_out_len=1024,
        batch_size=1,
        run_cfg=dict(num_gpus=1),
    ...
    # dict(
    #     type="LRQKChatBot",
    #     abbr=f"Mistral-7B-Instruct-v0.3_LRQKChatBot_r32_act2048_lite64_0.01",
    #     path='mistralai/Mistral-7B-Instruct-v0.3',
    #     max_out_len=1024,
    #     batch_size=1,
    #     run_cfg=dict(num_gpus=1),

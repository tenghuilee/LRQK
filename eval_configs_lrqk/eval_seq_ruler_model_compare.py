...
models = [
    dict(
        type="LRQKChatBot",
        abbr=f"llama-3-8B-1M_LRQKChatBot_r{r}_act{act}_lite{lite}",
        path="gradientai/Llama-3-8B-Instruct-Gradient-1048k",
        max_out_len=1024,
        batch_size=1,
        run_cfg=dict(num_gpus=1),
        lrqk_rank =r,
        lrqk_num_active_tokens = act,
        lrqk_lite_tokens = lite,
    ),
    dict(
        type="LRQKChatBot",
        abbr=f"Qwen2.5-7B_LRQKChatBot_r{r}_act{act}_lite{lite}",
